...
export const createMenuItem =({menu,jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({try:CREATE_MENU_ITEM_FAILURE,payload:error})
        }
    }
};
...
export const getMenuItemsByRestaurantId =({reqData}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            console.log("catch error ",error);
            dispatch({try:GET_MENU_ITEMS_BY_RESTAURANT_ID_FAILURE,payload:error})
        }
    }
};
...
export const updateMenuItemAvailability =({foodId, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            console.log("catch error ",error);
            dispatch({try:UPDATE_MENU_ITEMS_AVAILABILITY_FAILURE,payload:error})
        }
    }
};
...
export const deleteFoodAction =({foodId, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            console.log("catch error ",error);
            dispatch({try:DELETE_MENU_ITEM_FAILURE,payload:error})
        }
    }
};