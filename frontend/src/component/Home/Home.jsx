    ...
    <div className='pb-10'>
        ...
        items-center'>
            ...
            <div className='w-[50vw] z-10 text-center'>
                <p className='text-2xl lg:text-6xl font-bold z-10 py-5'>Order Food</p>
                <p className='z-10 text-gray-300 text-xl lg:text-4xlc'>Taste the Convenience:Food,Fast and Delivered.</p>
